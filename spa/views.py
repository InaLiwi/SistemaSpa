...
def servicios(request):
    ...
    return render(request, 'paginas/servicios.html', {'servicios': servicios})
...
def c_servicios(request):
    ...
    return render(request, 'paginas/c_servicios.html', {'formulario':formulario})

def u_servicios(request, servicio_id):
    ...
    return render(request, 'paginas/u_servicios.html', {'formulario': formulario})

def d_servicios(request, servicio_id):
